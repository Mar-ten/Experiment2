...
\begin{figure}[H]
	...
	\caption{Contour plot of experimental values $K_1^{u_x}$.  Values above 10 $MPa\sqrt{m}$ have been set to 0 for clarity}
	\label{fig:kU}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Contour plot of experimental values $K_1^{u_y}$. Values above 10 $MPa\sqrt{m}$ have been set to 0 for clarity}
	\label{fig:kV}
\end{figure}
